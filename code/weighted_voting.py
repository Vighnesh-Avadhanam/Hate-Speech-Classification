...
plt.plot(fpr, tpr, label=f"Weighted Voting (AUC = {roc_auc:.3f})", linewidth=2)
...
plt.grid(True)
plt.tight_layout()
plt.savefig("../figures/weighted_voting_roc.png")
plt.show()
...
plt.title("Precision-Recall Curve - Weighted Voting Ensemble")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("../figures/weighted_voting_pr.png")
plt.show()
